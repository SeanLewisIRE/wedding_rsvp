            ...
            <div className="flex flex-col lg:flex-row content-around lg:w-3/4 mx-auto">
                <div className="lg:w-2/4">
                    ...
                    <p className="w-4/5 md:w-3/5 lg:w-3/5 mx-auto text-left text-justify mb-4">
                        Rathfeigh Church is located just off the N2 between Ashbourne and Slane. The Rathfeigh turn is clearly marked. From the Dublin direction, the turn will be on your left. The church is tucked away down a quiet cul de sac.           
                    </p>
                </div>
