...
const Directions = () => {
    return (
        <div className='diretions-container bg-white text-center' id="directions">
            ...
            <div className="flex w-80 mx-auto text-left my-4">
            ...
            <iframe 
                ...
                allowFullScreen=""
                loading="lazy"
                className="mx-auto my-1 border border-dashed border-light-blue-500 p-1"
                // className=' h-96 w-96'
            />
            ...
            <p className="w-80 mx-auto text-left">
            ...
            <div className="flex w-80 mx-auto text-justify my-4">
                <div className="mx-auto">
