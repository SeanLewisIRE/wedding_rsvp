...
const Directions = () => {
    return (
        <div className='diretions-container bg-white text-center' id="directions">
            <h2>Directions</h2>
            <h3 className='line-break-header'><span>TO RATHFEIGH CHURCH</span></h3>
            
            <div className="flex w-4/5 mx-auto text-left my-4">
            ...
            <p className="w-4/5 md:w-3/5 mx-auto text-left mb-4">
            ...
            <h3 className='line-break-header'><span>TO TANKARDSTOWN HOUSE</span></h3>

            <div className="flex w-4/5 mx-auto text-justify my-4">
                <div className="mx-auto">
            ...
            <p className="w-4/5 md:w-3/5 mx-auto text-justify mb-4">
            ...
            <h3 className='line-break-header'> <span><FaTaxi className="inline" /> TAXI - Airport Collection</span></h3>
