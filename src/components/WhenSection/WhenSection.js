            ...
            <div class="container w-80 mx-auto">
                <div class="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
                    ...
                    <div class="flex flex-row-reverse md:contents">
                        <div
                            class="col-start-1 col-end-5 p-4 rounded-xl my-4 mr-auto text-left md:ml-auto md:mr-0 md:text-right"
                        >
                            <h3>CEREMONY</h3>
                        ...
                        <div class="col-start-5 col-end-6 md:mx-auto relative mr-10">
                            <div class="h-full w-6 flex items-center justify-center">
                                <div class="h-full w-1 gold pointer-events-none"></div>
                            </div>
                            <div
                                class="w-6 h-6 absolute top-1/2 -mt-3 rounded-full gold"
                            ></div>
                        </div>
                    </div>
                    ...
                    <div class="flex md:contents">
                        ...
                        <div
                            class="col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto text-left"
                        >
                            <h3>BBQ</h3>
